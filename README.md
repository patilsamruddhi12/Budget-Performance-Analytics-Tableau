...
## 📌 Business Objective
Organizations often struggle to understand whether budget allocations are being used effectively. This project focuses on analyzing budget distribution, monthly spending intensity, and long-term budget trends to support data-driven financial planning and strategic decision-making.

---

## 🧾 Dataset Overview
The dataset includes project-level financial data across multiple divisions:
Manufacturing, Healthcare, Finance, Retail, Education, and Technology.
...
## ✅ Conclusion
This project demonstrates how Tableau can transform raw financial data into meaningful insights by analyzing budget allocation patterns, seasonality, and long-term trends to support strategic planning.
